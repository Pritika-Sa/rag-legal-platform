"""
Vendored from AI4Bharat's IndicTrans2
(https://github.com/AI4Bharat/IndicTrans2, inference/normalize_regex_inference.py,
MIT licensed). Wraps URLs/emails/numbers/handles in placeholders before
translation so the model can't mangle them, and normalizes Indic numerals
to Roman script first.
"""
